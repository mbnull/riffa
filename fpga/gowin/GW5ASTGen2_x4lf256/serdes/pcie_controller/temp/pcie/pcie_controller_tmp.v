...
//--------Copy here to design--------
	...
	PCIE_Controller_Top your_instance_name(
		...
		.pcie_tl_int_status_i(pcie_tl_int_status_i_i), //input pcie_tl_int_status_i
		.pcie_tl_int_req_i(pcie_tl_int_req_i_i), //input pcie_tl_int_req_i
		.pcie_tl_int_msinum_i(pcie_tl_int_msinum_i_i), //input [4:0] pcie_tl_int_msinum_i
		.pcie_tl_int_ack_o(pcie_tl_int_ack_o_o), //output pcie_tl_int_ack_o
